...
const ItineraryAnalyticModel = mongoose.model('itineraryAnalytic', itineraryAnalyticSchema);

export default { ExampleModel, ItineraryAnalyticModel }; // Export the model
