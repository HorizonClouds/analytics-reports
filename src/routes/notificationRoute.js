...
router.get('/v1/itinerary', notificationController.getItineraryAnalytics); // Nueva ruta GET para obtener análisis de itinerarios
...
router.delete('/v1/notifications/:id', notificationController.deleteItineraryAnalytic); // Nueva ruta DELETE para eliminar análisis de itinerarios
